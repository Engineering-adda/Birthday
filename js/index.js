...
// Initialize fireworks and reveal
window.onload = function () {
  ...
  if (merrywrap) {
    ...
    if (box) {
      ...
      box.addEventListener("click", function openBox() {
...
function reveal() {
  ...
  if (merrywrap) merrywrap.style.backgroundColor = 'transparent';
  var img = document.createElement("img");
  img.src = "assets/images/Radha.png";
  img.style.width = window.innerWidth >= 1000 ? "288px" : "255px";
  img.style.height = window.innerWidth >= 1000 ? "190px" : "150px";
